...
void TextureViewer::draw() {
	...
	GLuint index = s->subroutine("SobelFilter");
...
void TextureViewer::setUpShaders() 
{
	...
	s->addUniform("tex");
	s->addUniform("depth");
	s->addSubroutine(GL_FRAGMENT_SHADER, "SobelFilter");
	s->addSubroutine(GL_FRAGMENT_SHADER, "GreyScale");
	s->addSubroutine(GL_FRAGMENT_SHADER, "Blurring");
	s->addSubroutine(GL_FRAGMENT_SHADER, "SepiaTone");
